...
function Feed() {
  return (
    <div className="flex flex-col md:flex-row h-screen w-screen bg-grey-bg overflow-hidden bg-gray-100">
      <div className="flex flex-col w-auto">
        <Navbar />
      </div>
      <section className="flex flex-col flex-1 p-4 md:p-8 m-2 md:m-6 overflow-y-auto">

        <h1 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-2 leading-tight">Welcome, Lola</h1>
        <h2 className="text-base md:text-xl lg:text-2xl font-light text-gray-500 mb-6 leading-tight">Find projects from other students and review them to earn credits</h2>
